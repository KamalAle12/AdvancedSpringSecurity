...
public class User {
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", email=" + email + ", password=" + password
				...
				+ ", credentialsExpiryDate=" + credentialsExpiryDate + ", accountExpiryDate=" + accountExpiryDate
				+ ", twoFactorSecret=" + twoFactorSecret + ", isTwoFactorEnabled=" + isTwoFactorEnabled
				+ ", signUpMethod=" + signUpMethod + ", role=" + role + ", createdDate=" + createdDate
