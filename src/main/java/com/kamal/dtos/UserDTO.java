...
public class UserDTO {
	...
	public String toString() {
		return "UserDTO [userId=" + userId + ", userName=" + userName + ", email=" + email + ", accountNonLocked="
				+ accountNonLocked + ", accountNonExpired=" + accountNonExpired + ", credentialsNonExpired="
				+ credentialsNonExpired + ", enabled=" + enabled + ", credentialsExpiryDate=" + credentialsExpiryDate
				+ ", accountExpiryDate=" + accountExpiryDate + ", twoFactorSecret=" + twoFactorSecret
				+ ", isTwoFactorEnabled=" + isTwoFactorEnabled + ", signUpMethod=" + signUpMethod + ", role=" + role
